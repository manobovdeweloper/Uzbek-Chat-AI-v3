  ...
  return (
    <div className="flex h-full w-72 flex-col glass-sidebar text-sidebar-foreground border-r border-sidebar-border">
      ...
      <div className="px-3.5 py-3 border-t border-sidebar-border space-y-2.5">
        ...
        {/* Admin panel shortcut — only for admin email */}
        {user?.emailAddresses[0]?.emailAddress === "abdullohmanopov24@gmail.com" && (
          <a href="/admin"
            className="flex items-center gap-2 px-3 py-2 rounded-xl bg-purple-600/15 hover:bg-purple-600/25 border border-purple-500/30 transition-all group">
            <div className="w-5 h-5 rounded-md bg-gradient-to-br from-purple-600 to-indigo-600 flex items-center justify-center flex-shrink-0">
              <svg className="w-3 h-3 text-white" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m5.618-4.016A11.955 11.955 0 0112 2.944a11.955 11.955 0 01-8.618 3.04A12.02 12.02 0 003 9c0 5.591 3.824 10.29 9 11.622 5.176-1.332 9-6.03 9-11.622 0-1.042-.133-2.052-.382-3.016z" />
              </svg>
            </div>
            <span className="text-xs font-semibold text-purple-400 group-hover:text-purple-300 transition-colors">Admin Panel</span>
            <svg className="w-3 h-3 text-purple-400/50 ml-auto" fill="none" viewBox="0 0 24 24" stroke="currentColor">
